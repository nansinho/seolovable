              ...
              <AnimatedSection delay={550}>
                <div className="mt-16 pt-12 border-t border-border">
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-12 md:gap-20">
                    <img src="/logos/openai.svg" alt="OpenAI" className="h-16 md:h-20 brightness-0 invert opacity-90 hover:opacity-100 transition-opacity duration-300" />
                    <img src="/logos/google.svg" alt="Google" className="h-16 md:h-20 brightness-0 invert opacity-90 hover:opacity-100 transition-opacity duration-300" />
                    <img src="/logos/claude.svg" alt="Claude" className="h-16 md:h-20 brightness-0 invert opacity-90 hover:opacity-100 transition-opacity duration-300" />
                    <img src="/logos/gemini.svg" alt="Gemini" className="h-16 md:h-20 brightness-0 invert opacity-90 hover:opacity-100 transition-opacity duration-300" />
                    <img src="/logos/grok.svg" alt="Grok" className="h-16 md:h-20 brightness-0 invert opacity-90 hover:opacity-100 transition-opacity duration-300" />
                  </div>
                </div>
              </AnimatedSection>
            </div>

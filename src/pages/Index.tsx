            ...
            <AnimatedSection delay={150}>
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 md:gap-10 items-center justify-items-center max-w-5xl mx-auto">
                <div className="flex items-center justify-center h-14 w-full">
                  <img src="/logos/openai.svg" alt="OpenAI" className="h-17 w-auto brightness-0 invert opacity-80 hover:opacity-100 transition-opacity duration-300" />
                </div>
                <div className="flex items-center justify-center h-14 w-full">
                ...
                <div className="flex items-center justify-center h-14 w-full">
                  <img src="/logos/claude.svg" alt="Claude" className="h-17 w-auto brightness-0 invert opacity-80 hover:opacity-100 transition-opacity duration-300" />
                </div>
                <div className="flex items-center justify-center h-14 w-full">
                  <img src="/logos/gemini.svg" alt="Gemini" className="h-17 w-auto brightness-0 invert opacity-80 hover:opacity-100 transition-opacity duration-300" />
                </div>
